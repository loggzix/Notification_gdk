...
namespace DSDK.Notifications
{
    ...
    public partial class NotificationServices
    {
        ...
        {
            if (cachedAndroidSdkInt.HasValue) return cachedAndroidSdkInt.Value;
...
#pragma warning restore CS0618
        ...
        public void SetAndroidChannelConfig(AndroidChannelConfig config)
        {
            ...
            {
                Debug.LogWarning(
                    "[NotificationServices] Channel config updated, but channel already registered. Restart to apply.");
            }
        }
