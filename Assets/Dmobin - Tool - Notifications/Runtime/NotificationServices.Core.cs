...
namespace DSDK.Notifications
{
    ...
    public partial class NotificationServices
    {
        ...
        public enum RepeatInterval : byte
        {
            None,
            Daily,
            Weekly,
        ...
        public sealed class NotificationData
        {
            ...
            public bool IsValid() =>
                !string.IsNullOrEmpty(title) && !string.IsNullOrEmpty(body) && fireTimeInSeconds >= 0;
        ...
        public sealed class NotificationBuilder
        {
            ...
            public NotificationBuilder WithIdentifier(string identifier)
            {
                data.identifier = identifier;
                return this;
            }

            public NotificationBuilder In(TimeSpan delay)
            {
                data.fireTimeInSeconds = (int)delay.TotalSeconds;
                return this;
            }

            public NotificationBuilder In(int seconds)
            {
                data.fireTimeInSeconds = seconds;
                return this;
            }
            ...
            public NotificationBuilder WithGroup(string groupKey)
            {
                data.groupKey = groupKey;
                return this;
            }

            public NotificationBuilder WithBadge(int badgeCount)
            {
                data.customBadgeCount = badgeCount;
                return this;
            }
            ...
            public bool Schedule()
            {
                if (!data.IsValid())
                {
                    ...
                    if (string.IsNullOrEmpty(data.title)) errorDetails.Append("missing title");
    ...
    private AndroidChannelConfig channelConfig = new AndroidChannelConfig();
        ...
        private static string GetNotificationStoreTempPath() => GetNotificationStorePath() + ".tmp";
